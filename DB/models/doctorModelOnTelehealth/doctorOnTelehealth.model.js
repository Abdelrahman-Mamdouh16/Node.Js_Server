...
const doctorOnTelehealthSchema = mongoose.Schema({
...
const doctorOnTelehealth = mongoose.model("DoctorOnTelehealth",doctorOnTelehealthSchema)
export default doctorOnTelehealth;
